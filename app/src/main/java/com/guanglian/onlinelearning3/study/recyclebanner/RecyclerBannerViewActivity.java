package com.guanglian.onlinelearning3.study.recyclebanner;
 ...
 */
public class RecyclerBannerViewActivity extends FrameLayout {
    ...
    public RecyclerBannerViewActivity(Context context) {
        this(context,null);
    }

    public RecyclerBannerViewActivity(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public RecyclerBannerViewActivity(Context context, AttributeSet attrs, int defStyleAttr) {
